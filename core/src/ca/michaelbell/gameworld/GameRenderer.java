...
public class GameRenderer {
    ...
    public void render(float runTime) {
        ...
        while (itr.hasNext()) { // iterator
            ...
            batcher.draw(AssetLoader.playerTexture, square.getX(), square.getY(), square.getWidth(), square.getHeight()); // Draw the player... He probably could be a rectangle... Oh well
        }
        batcher.end();
    }
}
